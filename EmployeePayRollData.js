...
}
{
    try
{
let employeePayroll = new EmployeePayroll(1, "prasanna", 30000, "F", new Date("5/7/2022").toLocaleDateString(), "prasanna@gmail.com", 521329);
    console.log(employeePayroll.Employee());
    employeePayroll = new EmployeePayroll(2, "arjun", 40000, "M", new Date("6/7/2022").toLocaleDateString(), "arjun@gmail.com", 530048);
    console.log(employeePayroll.Employee());
    employeePayroll.id = 3;
    employeePayroll.name = "malli";
    employeePayroll.salary = 200.00;
    employeePayroll.gender = "M";
    employeePayroll.startDate = new Date("6-7-2022").toLocaleDateString();
    employeePayroll.email = "malligmail.com";
    employeePayroll.zipCode = 240001;
    console.log(employeePayroll.Employee());
